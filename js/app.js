...
class MenuList {
    constructor() {
        this.menuItemPool = [
            ...
            { title: 'multiplanner', description: 'Комплексная автоматизация ТВ', src: 'img/oplanlogo.png'},
...
class ContentList {
    constructor() {
        this.contentImagesPool = [
            ...
            { title: 'vplay 5', imagePool: ['img/VPLAY RUS WEB-0.jpg','img/VPLAY RUS WEB-1.jpg']},
            { title: 'vrec', imagePool: ['img/VREC RUS WEB-0.jpg','img/VREC RUS WEB-1.jpg']},
            { title: 'multiplanner', imagePool: ['img/OPLAN RUS WEB-0.jpg','img/OPLAN RUS WEB-1.jpg']},
